...
final class URLPillMarkTests: XCTestCase {
    ...
    /// scheme the bar accepts — so without this the new tab wore a globe.
    func testLunasOwnPagesAreASearch() {
        XCTAssertEqual(Mark.reading("luna://newtab"), .search)
    }
    ...
    func testTheMarkNeverDisagreesWithWhatReturnWouldDo() {
        let inputs = [
            ...
            "", "luna://newtab", "ftp://example.com", "a.b.c.d.example.co.uk"
        ]
        for input in inputs {
