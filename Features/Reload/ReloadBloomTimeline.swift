...
//
//  It exists as its own type for one reason: §7's "a load finishing under
//  0.15 s plays nothing" is the rule that is easy to get subtly wrong, and it
...
//  therefore disarms before anything is ever composited.
//
